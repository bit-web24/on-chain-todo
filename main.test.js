...
describe('Server API Test', () => {
  ...
  it('should check server connection', async function() {
    ...
    assert.equal(res.body.isConnected, true);
    assert.equal(res.body.walletAddr, 'CT6KYufS97eHBSN3FWtH7M4wk3TJCy2anftTQi94du7q');
  });
  ...
  it('should get balance', async function() {
    ...
    assert.equal(res.status, 200);
    assert.equal(res.body.balance, 0.3987144);
  });
